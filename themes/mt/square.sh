...
tmux send-keys -t 1 "tmux select-pane -t 1 ;wafw00f reliance.reliance;tmux select-pane -t 3;"
tmux send-keys -t 1 "" Enter
tmux send-keys -t 2 "tmux select-pane -t 2 ;subfinder -d reliance.reliance;tmux select-pane -t 3;"
